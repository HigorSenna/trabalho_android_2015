...
public class CadastroPacienteSOAPActivity extends AppCompatActivity {
    ...
    private void cadastrarPaciente() throws Exception{
        ...
        String msg = new CadastroPacienteSOAP(paciente.getCpfPaciente(),paciente.getNmPaciente()).execute().get();
